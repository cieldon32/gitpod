...
export interface AdminServer {
    ...
    params(params: AdminServer.AdminGetUserParmas): Promise<User>;
    adminBlockUser(params: AdminServer.AdminBlockUserParams): Promise<User>;
    params(params: AdminServer.AdminModifyRoleOrPermissionParams): Promise<User>;
    params(params: AdminServer.AdminModifyPermanentWorkspaceFeatureFlagParams): Promise<User>;
...
export namespace AdminServer {
    ...
    export interface AdminGetUserParmas {
        readonly id: string;
    }
